...
plt.plot(P1[0, 0], P1[1, 0], 'ro', label=f'P1 ({P1[0,0]:.2f}, {P1[1,0]:.2f})')
plt.plot(P2[0, 0], P2[1, 0], 'go', label=f'P2 ({P2[0,0]:.2f}, {P2[1,0]:.2f})')

plt.text(center[0] + 0.1, center[1], 'C', fontsize=14)
plt.text(h[0, 0] + 0.1, h[1, 0], 'O', fontsize=14)
plt.text(P1[0, 0], P1[1, 0] + 0.2, r'$P_1$', fontsize=14, ha='center')
plt.text(P2[0, 0], P2[1, 0] - 0.3, r'$P_2$', fontsize=14, ha='center')
